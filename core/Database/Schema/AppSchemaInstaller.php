...
final class AppSchemaInstaller
{
    ...
    public function install(string $appCode, bool $continueOnError = false): SchemaInstallResult
    {
        $files = $this->files($appCode);
        $executedStatements = [];
        $errors = [];
     ...
     * @return string[]
     */
    public function files(string $appCode): array
    {
        return $this->dataDefResolver->allApp($appCode);
    }
