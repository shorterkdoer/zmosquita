<?php    //edit view para extranjero
return [    'config' => [
                'titulo' => 'Matricula',
                'subtitulo' => 'Profesionales con títulos extranjeros - Adjuntar (PNG, JPG, JPEG)',
                'action' => 'update',
                'url_action' => '/titulodeotranacion',
                'method' => 'POST',
                'tipo' => 'form',
                'field_id' => 'user_id',
            ],
            ...
            'campos' => [
                'notaddjj' => [
                    ...
                    'hidden' => false,
                    'required' => false,
                    'placeholder' => 'Declaración Jurada',
