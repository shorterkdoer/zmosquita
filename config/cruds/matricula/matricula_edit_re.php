<?php    //edit view para rematriculados
return [    'config' => [
                'titulo' => 'Matricula',
                'subtitulo' => 'Adjuntar documentos para la matricula (PNG, JPG, JPEG)',
                'action' => 'update',
                'url_action' => '/rematricula',
                'method' => 'POST',
                'tipo' => 'form',
                'field_id' => 'user_id',
            ],
            ...
            'campos' => [
                'matriculaministerio' => [
                    ...
                    'hidden' => false,
                    'required' => false,
                    'placeholder' => 'Matrícula otorgada por el Ministerio',
                    'help' => 'Número de matrícula otorgada por el Ministerio',
                    'link' => '',
                    'class' => 'form-control',
                    'style' => 'width: 100%;',
                    'autocomplete' => 'off',
                ...
                'notaddjj' => [
                    'nombre' => 'notaddjj',
                    'type' => 'file',
                    'label' => 'Nota solicitud de matrícula',
                    'maxlength' => 255,
                    'readonly' => false,
                    'hidden' => false,
                    'required' => false,
