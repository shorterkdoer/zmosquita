...
return [    'config' => 
                [
                    'titulo' => 'Profesionales que pasaron el control físico',
                    'subtitulo' => 'En condiciones de otorgar matrícula',
                    'field_id' => 'id',
                    'tipo' => 'table',
                    'subtitle' => 'Inscriptos',
                    'action' => '',
            ...
            'QrySpec' => 
                ...
                'filter' => '(m.baja is null) and (m.aprobado is not null) and (m.verificado is not null) and (m.matriculaasignada is null) and (comisionotorgante is null)',
