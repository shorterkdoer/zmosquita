<?php    //edit view para matriculados en otras jurisdicciones
return [    'config' => [
                'titulo' => 'Matriculación',
                'subtitulo' => 'Profesionales con matrícula previa en otra jurisdicción - Adjuntar (PNG, JPG, JPEG)',
                'action' => 'update',
                'url_action' => '/previamatricula',
                'method' => 'POST',
                'tipo' => 'form',
                'field_id' => 'user_id',
            ],
            ...
            'campos' => [
                ...
                'matriculaprevia' => [
                    ...
                    'type' => 'file',
                    'label' => 'Matrícula Previa (de otra jurisdicción)',
                    'maxlength' => 255,
                    'readonly' => false,
                    'hidden' => false,
                    'required' => false,
                ...
                'certificadoetica' => [
                    ...
                    'type' => 'file',
                    'label' => 'Certificado de Ética',
                    'maxlength' => 255,
                    'readonly' => false,
                    'hidden' => false,
                    'required' => false,
                    'placeholder' => 'Certificado de Ética',
                    'help' => 'Adjunte el Certificado de Ética',
                    'link' => '',
                    'class' => 'form-control',
                    'style' => 'width: 100%;',
                    'autocomplete' => 'off',
