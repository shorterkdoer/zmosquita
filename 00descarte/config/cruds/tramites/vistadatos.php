...
return [
    'config' => [
        'title' => 'Asignación de Revisor (primera fase)',
        'titulo' => '',
        'field_id' => 'id',
        'tipo' => 'form',
        'icon' => 'person',
        ...
        'divname' => 'datospersonalesfrm', //nombre para el div del listado, si se usa AJAX
    ...
    'campos' => [
                'nombre' => ['nombre' => 'nombre', 'type' => 'text', 'label' => 'Nombre', 'placeholder' => 'Ingrese nombre', 'readonly' => true, 'hidden' => false, 'help' => 'Ingrese el nombre', 'class' => 'form-control', 'style' => 'width: 100%;', 'autocomplete' => 'off', 'pattern' => '[A-Za-z0-9 ]{1,255}', 'options' => [], 'columna_rel' => '', 'default' => 'NULL', 'tabla_rel' => ''],
        'apellido' => ['nombre' => 'apellido', 'type' => 'text', 'label' => 'Apellido', 'placeholder' => 'Ingrese apellido', 'readonly' => true, 'hidden' => false, 'help' => 'Ingrese el nombre', 'class' => 'form-control', 'style' => 'width: 100%;', 'autocomplete' => 'off', 'pattern' => '[A-Za-z0-9 ]{1,255}', 'options' => [], 'columna_rel' => '', 'default' => 'NULL', 'tabla_rel' => ''],
        'dni' => ['nombre' => 'dni', 'type' => 'text', 'label' => 'Dni', 'placeholder' => 'Ingrese dni', 'readonly' => true, 'hidden' => false, 'help' => 'Ingrese el nombre', 'class' => 'form-control', 'style' => 'width: 100%;', 'autocomplete' => 'off', 'pattern' => '[A-Za-z0-9 ]{1,255}', 'options' => [], 'columna_rel' => '', 'default' => 'NULL', 'tabla_rel' => ''],
        'user_id' => ['nombre' => 'user_id', 'type' => 'text', 'label' => 'User id', 'placeholder' => 'Ingrese user id', 'readonly' => true, 'hidden' => false, 'help' => 'Ingrese el nombre', 'class' => 'form-control', 'style' => 'width: 100%;', 'autocomplete' => 'off', 'pattern' => '[A-Za-z0-9 ]{1,255}', 'options' => [], 'columna_rel' => '', 'required' => true, 'tabla_rel' => ''],
        'ciudad_id' => 
            ['nombre' => 'ciudad_id', 
            'type' => 'select', 
            'label' => 'Ciudad id', 
        ...
        'provincia_id' => 
            ...
            'type' => 'select', 
            'label' => 'Provincia id', 
            'placeholder' => 'Ingrese provincia id', 
            'readonly' => true, 
            'hidden' => false, 
            'help' => 'Ingrese el nombre', 
            'class' => 'form-control', 
