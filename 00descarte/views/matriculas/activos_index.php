...
return [    'config' => 
                [
                    ...
                    'url_action' => '',
                    'method' => '',
                    'divname' => 'matriculasactivas',
                    'url_data' => '/api/matricula/activos', 
                    'link_id' => 'm.user_id',
                ],
            ...
            'QrySpec' => 
                ...
                'filter' => '(m.aprobado is not null)'.
                        'and (m.comisionotorgante is not null) and (m.baja is null)',
            ...
            'actividades' => [
                ...
                'Carnet' => [
                    'text' => 'Carnet',
                    //hay que crear la actividad y poner url_params a true
                    'url' => '/crearcarnet',  // Also removed trailing slash for consistency
                    'url_params' => true, // Indicates that the URL will include the ID
                ...
                'Otorgar' => [
                    ...
                    'url_params' => true, // Indicates that the URL will include the ID
                    'param_field' => 'd.matriculaasignada', // Specify the field to use as a parameter
